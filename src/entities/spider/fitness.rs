...
pub struct SpiderFitnessRaw {
    ...
    pub vc_score: u32,
    pub jump_score: u32,
    pub sit_and_reach_score: u32,
    pub pull_and_sit_score: u32,
    #[serde(rename = "50m_score")]
    pub short_run_score: u32,
    pub run_score: u32,
    pub total_score: f64,
    pub total_grade: String,
    pub basic_score: f64,
    pub extra_score_pull_or_sit_up: u32,
    pub extra_score_run: u32,
