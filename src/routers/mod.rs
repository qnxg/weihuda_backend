    ...
    handlers::{
        ...
        spider::{
            hdjw::{
                ...
                get_compulsory_course_grade_in_prev_xn_handler, get_computer_exam_arrange_handler,
                get_empty_room_handler, get_exam_arrange_handler, get_grade_chart_handler,
                get_grade_handler, get_grade_rank_handler, get_raw_grade_handler,
            },
...
pub fn create_router(db_pool: Arc<DbPool>) -> Router {
    ...
    let grade = Router::new()
        ...
        .route(
            "/hdjw/compulsory-course-grade-in-prev-xn",
            get(get_compulsory_course_grade_in_prev_xn_handler),
        ) // 获取上一个学年的必修课程加权平均成绩和课程个数，主要用来衡量奖学金
